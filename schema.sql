-- InternEdge MySQL Database Schema for XAMPP
...
-- 1. Students Table (Unified for PHP & Next.js)
CREATE TABLE students (
    ...
    skills TEXT NOT NULL, -- Stored as JSON array or list
    experience VARCHAR(50) NOT NULL, -- Fresher, Experienced / Intermediate
...
-- 2. Companies Table (Unified for PHP & Next.js)
...
-- 3. OTP Verifications Backup Table
...
-- Seed Student (Aarav Sharma) with hashed password 'password123'
...
-- Seed Companies with hashed password 'password123'
INSERT INTO companies (id, company_name, email, contact, password, industry_type, company_size, founded_year, website, description, country, state, city, full_address, verified) VALUES
(1, 'TechCorp Global Solutions', 'hr@techcorp.com', '+91 9988776655', '$2y$10$wH60pIecf2W0s9C1K3d5e.cM86gV2i/4K5QoBsn2d2dI8B3N.', 'IT', '10-50', 2015, 'https://techcorpglobal.com', 'We are a global IT and software development enterprise bridging student talent with practical industrial opportunities.', 'India', 'Karnataka', 'Bengaluru', '4th Block, Koramangala', 1),
(2, 'Innovate AI Labs', 'recruitment@innovate.io', '+91 9123456789', '$2y$10$wH60pIecf2W0s9C1K3d5e.cM86gV2i/4K5QoBsn2d2dI8B3N.', 'IT', '10-50', 2021, 'https://innovate.io', 'Leading artificial intelligence research and products lab focusing on natural language processing.', 'India', 'Telangana', 'Hyderabad', 'HITEC City', 1);
...
(2, 1, 'TechCorp Global Solutions', 'Full Stack Software Engineer', 'Full-Time', 'Bengaluru, India (Hybrid)', '₹12,000,000 / year', 'Permanent', 8.00, '["Node.js", "Express", "React", "MySQL", "Docker"]', '2026-08-15', 'Full-stack position for graduating seniors. Architect scalable web services and cloud-native applications with high availability.'),
...
-- Seed Application
INSERT INTO applications (job_id, student_id, status, recruiter_notes) VALUES
(1, 1, 'Shortlisted', 'Impressive portfolio projects. Technical screening scheduled for Friday.');
